"""Processes a raw audio file intended to be used for an audio interstitial screen"""
...
async def execute(
    ...
    *,
    ...
    """Processes the s3 file upload with the given uid as an audio interstitial screens
    audio.
    ...
    async def bounce():
        ...
        await jobs.enqueue(
            "runners.screens.audio_interstitial_process_audio",
