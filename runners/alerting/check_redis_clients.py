"""
Checks if any of the redis nodes or sentinels have more than 75 clients connected,
...
async def execute(itgs: Itgs, gd: GracefulDeath):
    ...
    sentinels have less than 75 clients connected. If any have more than 75 clients,
