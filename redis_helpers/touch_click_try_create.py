...
ClickedLinkRedisResultFailedToTrackReason = Literal[
    "not_requested",
...
class ClickLinkRedisResult:
    ...
    failed_to_track_reason: Optional[ClickedLinkRedisResultFailedToTrackReason]
...
_ordered_failed_to_track_reasons: List[ClickedLinkRedisResultFailedToTrackReason] = [
    "not_requested",
    "no_link_and_not_post_login",
    "parent_has_child",
    "no_parent",
...
def touch_click_try_create_parse_result(res) -> ClickLinkRedisResult:
    ...
    if not tracked:
        failed_to_track_reason = _ordered_failed_to_track_reasons[-res[0]]
