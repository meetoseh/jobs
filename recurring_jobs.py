...
JOBS: Tuple[Job, ...] = (
    ...
    Job(
        name="runners.alerting.check_backend",
        kwargs=tuple(),
        interval=JobInterval(pst, seconds=(0,)),
    ),
    Job(
        name="runners.alerting.check_email_templates",
        kwargs=tuple(),
        interval=JobInterval(pst, seconds=tuple(range(0, 60, 5))),
    ),
    Job(
    ...
    Job(
        name="runners.alerting.check_redis_clients",
        kwargs=tuple(),
        interval=JobInterval(pst, seconds=tuple(range(0, 60, 5))),
    ),
    Job(
    ...
    Job(
        name="runners.prune_old_user_home_screen_images",
        kwargs=tuple(),
        interval=JobInterval(
            pst, days_of_week=("sat",), hours=(9,), minutes=(0,), seconds=(0,)
        ),
    ),
    Job(
        name="runners.reprocess_profile_pictures",
        kwargs=tuple(),
        interval=JobInterval(
            pst, hours=(0, 1, 4, 5, 22, 23), minutes=(0, 15, 30, 45), seconds=(0,)
        ),
    ),
    Job(
        ...
        kwargs=tuple(),
        interval=JobInterval(
            pst, days_of_week=("sat",), hours=(8,), minutes=(0,), seconds=(0,)
        ),
    ),
    Job(
        name="runners.stats.daily_client_flow_stats",
        kwargs=tuple(),
        interval=JobInterval(pst, hours=(2,), minutes=(0,), seconds=(0,)),
    ),
    Job(
        name="runners.stats.daily_client_screen_stats",
        kwargs=tuple(),
        interval=JobInterval(pst, hours=(2,), minutes=(0,), seconds=(0,)),
    ),
    Job(
        name="runners.cleanup_old_user_client_screens",
        kwargs=tuple(),
        interval=JobInterval(pst, hours=(2,), minutes=(0,), seconds=(0,)),
    ),
    Job(
